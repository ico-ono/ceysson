...
<html>
<head>
<title>Livres, Ceysson Editions d'art</title>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1 " />
<meta name="description" content="Découvrez les livres édités par la maison d'édition Ceysson Editions d'Art"> 
...
<div id="page">
 ...
 <div id="aside">
    ...
    $select = 'SELECT count(*) FROM livres where editeur_livre = "ceysson"';
    ...
    $return = mysql_query('select * from livres where editeur_livre = "ceysson" order by parution_livre desc limit '.$limite.','.$nombre);
    while ($livres = mysql_fetch_array($return))
    {
    	if($total)
		{
            ...
            <a href="livre-'.$livres['ID_livre'].'-'.$titre_livre.'.html">
            ...
            <p>'.$faconnage.' <br/>
			 <p>';
		if($livres['prix_livre'] != 0){echo $livres['prix_livre'].'€';} else{echo '';} 
	echo'</p><br/></div></a></div>';
        }
    }
    ?>
...
<p>© Ceysson Éditions d'Art 2012  |  IAC Éditions d'Art est une marque I.A.C. média</p>
</div>
