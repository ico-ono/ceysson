...
<?php echo do_shortcode( '[cactus-masonry quality="large" post_category="IAC" display_post_titles="true" max_width="157px" max_height="600px" horizontal_spacing="17" vertical_spacing="17" infinite_scroll="false" posts_per_page="2" show_loader="false"]' );?>
    <!-- <?php if(have_posts()) : ?>
