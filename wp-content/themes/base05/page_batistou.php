 ...
 * @package Base
 * @author Ico-ono.com
 * Template Name: batistou
 */
?>
<? get_header(); ?>

    <!-- section -->
	<section id="batistou-01" class="block-center">
		<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
        	<?php the_content(); ?>
    <?php endwhile; endif; ?>
  </section>
	<section id="batistou-02" class="container">
		<div class="block-fonce left txtcenter">
			<?php echo rwmb_meta('rw_bloc1'); ?>
		</div>
  </section>
	<section id="batistou-03" class="container">
			<?php
			if(get_locale() == "fr_FR"){ echo masterslider("ms-2");}
			if(get_locale() == "en_US"){ echo masterslider("ms-2-1");}
			?>
  </section>
