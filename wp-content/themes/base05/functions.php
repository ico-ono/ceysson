...
$post_id = $_GET['post'] ? $_GET['post'] : $_POST['post_ID'] ;
  ...
  if ($template_file == 'page_home.php') {
	...
	if (($template_file == 'page_batistou.php')OR($template_file == 'page_ounoustrouver.php')OR($template_file == 'page_contact.php')) {
		add_filter( 'rwmb_meta_boxes', 'OneBlocMore_register_meta_boxes' );
	}
	// if ($template_file == 'page_produits.php') {
	// 	add_filter( 'rwmb_meta_boxes', 'TwoBlocMore_register_meta_boxes' );
	// }
	if (($template_file == 'page_savoirfaire.php')OR($template_file == 'page_produits.php')) {
		add_filter( 'rwmb_meta_boxes', 'ThreeBlocMore_register_meta_boxes' );
	}
